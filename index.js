...
//FIN DE REGISTRO  
	...
	if (budy.includes(`0`)||budy.includes(`anc`)||budy.includes(`nosotros`)|| budy.includes(`logistica`)) {
                  reply(
			  `*-----------Soluciones logísticas-----------*\n\ 
✅Nuestra experiencia en el sector, garantizará los resultados que necesitas
✅Especializados en logística y soportados en la mejora continua
✅Actualmente contamos con un equipo de más de 800 colaboradores y un staff ejecutivo con amplia experiencia en el sector 
✅orientado a la eficiencia operativa y obtención de resultados.
 
 Web de la empresa JL Seguridad: 
 🌐https://www.anclogistica.com/ \n\
...
desarrollo de tu empresa. \n\
 ...
 ◼️Atencion y asistencia al cliente
 ◼️control de calidad
 ◼️control de inventarios
 ◼️personal chopper
 ◼️piking pedidos e commerce
 ◼️packing  despacho de productos de alto valor
 ◼️Reposicion en gondola
 
 
 Web de la empresa ANC: 
 🌐https://www.anclogistica.com/empresa/
 *Ingresa otro número para ayudarte a resolver tus dudas* `);
...
▶️completa el formulario con tu información, selecciona la posición a la que postulas y adjunta tu CV detallado, ingresando al sigueinte link.
🌐Web de la empresa ANC para que te unas a nuesta bonita familia:https://www.anclogistica.com/trabaja-con-nosotros/	
*🤖Ingresa otro número para ayudarte a resolver tus dudas* `)
